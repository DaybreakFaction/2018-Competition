<#
    .SYNOPSIS
        Installs the Daybreak2018 Module from github
        
    .DESCRIPTION
        This script installs the Daybreak2018 Module from github.
