...
Remove-Module Daybreak2018Tools -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\Daybreak2018Tools.psd1"
Import-Module "$PSScriptRoot\..\Daybreak2018Tools.psm1" -Force
